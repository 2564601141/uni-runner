  ...
  <view class="content">
    <view class="forget-bg">
      <view class="forget-card"
        :style='{"boxShadow":"","backgroundColor":"#fff","borderColor":"rgba(74, 209, 242, 1)","borderRadius":"40rpx","borderStyle":"solid","borderWidth":"2rpx"}'>
        <view class="forget-input forget-margin-b">
          <input v-model="username"
            :style='{"borderColor":"rgba(74, 209, 242, 1)","backgroundColor":"#fff","borderRadius":"20rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
        ...
        <view class="login-input login-margin-b">
          <picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;"
            ...
            <view class="uni-input"
              :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'>{{options[index]}}
            </view>
          </picker>
        </view>
      </view>
    ...
    <view class="forget-btn">
      <button class="landing"
        :style='{"borderColor":"#ccc","backgroundColor":"rgba(241, 229, 98, 1)","borderRadius":"40rpx","color":"#333","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
