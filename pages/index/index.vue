<template>
	<view class="uni-padding-wrap">
		<view class="header">
			...
			<view class="right-content" @tap="onPageTap('xitonggonggao')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1)'}">
				查看更多
			</view>
		</view>
		<view v-if='1 == 1 || 1 == 2' class="uni-product-list" :class="1 == 2 ? 'active' : ''" :style='{"borderRadius":0,"backgroundColor":"rgba(135, 128, 128, 0.34)"}'>
			<view @tap="onDetailTap('xitonggonggao',product.id)" :style='{"borderRadius":"12rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in homexitonggonggaolist" :key="index">
		...
		<view class="list" v-if='1 == 3' :style='{"borderRadius":0,"backgroundColor":"rgba(135, 128, 128, 0.34)"}'>
			<view :style='{"borderRadius":"12rpx","backgroundColor":"#fff"}' @tap="onDetailTap('xitonggonggao',product.id)" v-for="(product,index) in homexitonggonggaolist" :key="index" class="listm flex flex-between">
																<view class="listmr">
